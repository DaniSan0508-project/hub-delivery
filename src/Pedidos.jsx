...
function Pedidos() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      ...
      // Mock order data
      setOrders([
        { id: '001', customer: 'João Silva', total: 'R$ 45,90', status: 'Preparando', time: '15:30' },
        { id: '002', customer: 'Maria Oliveira', total: 'R$ 78,50', status: 'Pronto', time: '15:25' },
        { id: '003', customer: 'Carlos Souza', total: 'R$ 32,00', status: 'Entregue', time: '15:10' },
        { id: '004', customer: 'Ana Costa', total: 'R$ 56,75', status: 'Recebido', time: '15:05' }
      ]);
    }
  }, [navigate]);
